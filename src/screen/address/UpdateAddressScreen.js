...
export default function UpdateAddressScreen({route, navigation}) {
    ...
    const [addressDetails, setAddressDetails] = useState(item.geoAddress);

    const [region, setRegion] = useState({
        latitude: item.geoAddress.geometry.location.lat,
        longitude: item.geoAddress.geometry.location.lng,
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.content}>
                <View style={styles.topBar}>
                    ...
                    <TouchableOpacity style={styles.scanner} onPress={() => {
                        dispatch(AddressAction.removeAddress({
                            place_id: item.geoAddress.place_id
                        })).then(data => {
                            navigation.goBack();
                        })
                    }}>
                                ...
                                <View style={styles.receiverInformation}>
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <View style={{width: '48%', marginRight: '1%'}}>
                                            <Controller
                                                ...
                                                name="firstName"
                                                defaultValue={item.physicalAddress.firstName}
                                        ...
                                        <View style={{width: '48%', marginLeft: '1%'}}>
                                            <Controller
                                                ...
                                                name="lastName"
                                                defaultValue={item.physicalAddress.lastName}
                                            />
                                        </View>
                                    </View>
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <View style={{width: '48%', marginRight: '1%'}}>
                                            <Controller
                                                ...
                                                name="phoneNumber"
                                                defaultValue={item.physicalAddress.phoneNumber}
                                        ...
                                        <View style={{width: '48%', marginLeft: '1%'}}>
                                            <Controller
                                                ...
                                                name="email"
                                                defaultValue={item.physicalAddress.email}
                                            />
                                        </View>
                                    </View>
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <Controller
                                            ...
                                            name="address_1"
                                            defaultValue={item.physicalAddress.address_1}
                                    ...
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <Controller
                                            ...
                                            name="address_2"
                                            defaultValue={item.physicalAddress.address_2}
                                        />
                                    </View>
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <Controller
                                            ...
                                            name="city"
                                            defaultValue={item.physicalAddress.city}
                                        />
                                    </View>
                                    ...
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <Controller
                                            ...
                                            name="state"
                                            defaultValue={item.physicalAddress.state}
                                        />
                                    </View>
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <Controller
                                            ...
                                            name="postal_code"
                                            defaultValue={item.physicalAddress.postal_code}
                                        />
                                    </View>
                                    <View style={{width: '100%', flexDirection: 'row'}}>
                                        <Controller
                                            ...
                                            name="country"
                                            defaultValue={item.physicalAddress.country}
                                        />
                                    </View>
